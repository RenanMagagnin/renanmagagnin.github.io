if (function(t, e) {
        ...
        function J() {
            try {
                return new t.ActiveXObject("Microsoft.XMLhttps")
            } catch (t) {}
        }
        ...
        ft.extend({
            ...
            ajax: function(e, n) {
                ...
                if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, f.url = ((e || f.url || Ye) + "").replace(Fe, "").replace(Qe, Ze[1] + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = ft.trim(f.dataType || "*").toLowerCase().match(At) || [""], null == f.crossDomain && (o = Ve.exec(f.url.toLowerCase()), f.crossDomain = !(!o || o[1] === Ze[1] && o[2] === Ze[2] && (o[3] || ("https:" === o[1] ? "80" : "443")) === (Ze[3] || ("https:" === Ze[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = ft.param(f.data, f.traditional)), U(Xe, f, n, T), 2 === w) return T;
            ...
            if (!e.crossDomain || ut.cors) {
                ...
                return {
                    send: function(i, o) {
                        ...
                        e.mimeType && s.overrideMimeType && s.overrideMimeType(e.mimeType), e.crossDomain || i["X-Requested-With"] || (i["X-Requested-With"] = "XMLhttpsRequest");
